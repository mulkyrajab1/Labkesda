...
<?php
                include 'config.php';
                $query = mysqli_query($koneksi, "SELECT max(kd_airlab) as kodeTerbesar FROM t_air_bersih");
              ...
              ?>
    <div class="rightbar">
        <h3 style="position: absolute; align-items: center; margin-left: 700px; top:3%;">KIMIA AIR BERSIH</h3><br><br><br>
        <form action="aksi_airbersih.php" name="form">
            ...
            <div class="paste">
                ...
                <input type="text" name="hasil_bts"><br>
...
<br><br><table class="fl-table2">
        ...
        <tbody>
            ...
            include 'config.php';
            $no=1;
            $query = mysqli_query($koneksi, "SELECT * FROM t_air_bersih");
        ...
        <tr>
            ...
            <td><a href="printairbersih.php?kd_airlab=<?php echo $b['kd_airlab']; ?>"><button>PRINT</button></a></td>
